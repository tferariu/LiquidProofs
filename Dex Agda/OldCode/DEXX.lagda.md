...
private variable U V : Set

postulate
  --Map N Z
  Mop : (U : Set) -> (V : Set) -> Set
  --insertion
  insert : U × V -> Mop U V -> Mop U V
  --query
  belongs : U -> Mop U V -> Set
  query : (m : Mop U V) (k : U) {_ : belongs k m} -> V
  --deletion
  leq : Mop U V -> Mop U V -> Set
  decleq : ∀ (m m' : Mop U V) -> Dec ( leq m m' )
  minus : (m : Mop U V) (m' : Mop U V) {_ : leq m m' } -> Mop U V
