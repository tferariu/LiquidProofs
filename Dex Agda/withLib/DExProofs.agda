...
validatorImpliesTransition : ∀ {adr oref} (par : Params) (d : Datum) (i : Input) (ctx : ScriptContext)
                           -> i ≢ Close
...
bothImplyClose : ∀ (par : Params) (d : Datum) (adr : Address) (oref : TxOutRef) (top : ⊤) (ctx : ScriptContext)
...
closeImpliesBoth : ∀ (par : Params) (d : Datum) (adr : Address) (oref : TxOutRef) (top : ⊤) (ctx : ScriptContext)
               -> getPar par adr oref ⊢ getS d ctx ~[ Close ]~| getS' ctx
               -> ((agdaValidator par d Close ctx && agdaPolicy adr oref top ctx) ≡ true)
...
totalF (par , adr , oref , d , Close , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = +_ zero ; tokAssetClass = tokAssetClass }) = agdaValidator par d Close ctx && agdaPolicy adr oref tt ctx
totalF (par , adr , oref , d , Update v r , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = negsuc n ; tokAssetClass = tokAssetClass }) = agdaValidator par d (Update v r) ctx
...
totalR : Argument -> Set
totalR (par , adr , oref , d , i , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = +[1+ n ] ; tokAssetClass = tokAssetClass }) = getPar par adr oref ⊢ getS' ctx
totalR (par , adr , oref , d , Update v r , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = +_ zero ; tokAssetClass = tokAssetClass }) = getPar par adr oref ⊢ getS d ctx ~[ Update v r ]~> getS' ctx
totalR (par , adr , oref , d , Exchange amt pkh , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = +_ zero ; tokAssetClass = tokAssetClass }) = getPar par adr oref ⊢ getS d ctx ~[ Exchange amt pkh ]~> getS' ctx
totalR (par , adr , oref , d , Close , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = +_ zero ; tokAssetClass = tokAssetClass }) = getPar par adr oref ⊢ getS d ctx ~[ Close ]~| getS' ctx
totalR (par , adr , oref , d , Update v r , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = negsuc n ; tokAssetClass = tokAssetClass }) = getPar par adr oref ⊢ getS d ctx ~[ Update v r ]~> getS' ctx
totalR (par , adr , oref , d , Exchange amt pkh , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = negsuc n ; tokAssetClass = tokAssetClass }) = getPar par adr oref ⊢ getS d ctx ~[ Exchange amt pkh ]~> getS' ctx
totalR (par , adr , oref , d , Close , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = negsuc n ; tokAssetClass = tokAssetClass }) = getPar par adr oref ⊢ getS d ctx ~[ Close ]~| getS' ctx


totalEquiv : totalF ≈ totalR
totalEquiv = record { to =
  λ { {par , adr , oref , d , i , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = +[1+ n ] ; tokAssetClass = tokAssetClass }} x → mintingImpliesStart adr oref tt ctx (λ ()) x ;
      {par , adr , oref , d , Update v r , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = +_ zero ; tokAssetClass = tokAssetClass }} x → validatorImpliesTransition par d (Update v r) ctx (λ ()) x ;
      {par , adr , oref , d , Exchange amt pkh , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = +_ zero ; tokAssetClass = tokAssetClass }} x → validatorImpliesTransition par d (Exchange amt pkh) ctx (λ ()) x ;
      {par , adr , oref , d , Close , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = +_ zero ; tokAssetClass = tokAssetClass }} x → bothImplyClose par d adr oref tt ctx x ;
      {par , adr , oref , d , Update v r , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = negsuc n ; tokAssetClass = tokAssetClass }} x → validatorImpliesTransition par d (Update v r) ctx (λ ()) x ;
      {par , adr , oref , d , Exchange amt pkh , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = negsuc n ; tokAssetClass = tokAssetClass }} x → validatorImpliesTransition par d (Exchange amt pkh) ctx (λ ()) x ;
      {par , adr , oref , d , Close , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = negsuc n ; tokAssetClass = tokAssetClass }} x → bothImplyClose par d adr oref tt ctx x } ;
                      from =
  λ { {par , adr , oref , d , i , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = +[1+ n ] ; tokAssetClass = tokAssetClass }} x → startImpliesMinting adr oref tt ctx x ;
      {par , adr , oref , d , Update v r , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = +_ zero ; tokAssetClass = tokAssetClass }} x → transitionImpliesValidator par d (Update v r) ctx x ;
      {par , adr , oref , d , Exchange amt pkh , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = +_ zero ; tokAssetClass = tokAssetClass }} x → transitionImpliesValidator par d (Exchange amt pkh) ctx x ;
      {par , adr , oref , d , Close , ctx@record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = outputDatum ; payTo = payTo ; payVal = payVal ; buyTo = buyTo ; buyVal = buyVal ; signature = signature ; continues = continues ; inputRef = inputRef ; mint = +_ zero ; tokAssetClass = tokAssetClass }} x → closeImpliesBoth par d adr oref tt ctx x ;
...
{-
  record { to = λ { {(par , adr , oref , d , i , ctx)} y →
                  validatorImpliesTransition par d i ctx {!!} ?}
         ; from = λ { {(par , adr , oref , d , i , ctx)} y →
                  transitionImpliesValidator par d i ctx ? }}-}

{-record { to = λ { x → {!validatorImpliesTransition!}}
                      ; from = λ x → transitionImpliesValidator {!!} {!!} {!!} {!!} {!!} }-}

--record { to = {!!} ; from = {!!} }



 --(go (checkDatum adr ctx) (go (consumes oref ctx) (go (continuingAddr adr ctx) p2)))
{-
(tok , lab) ≡
      (tokAssetClass ,
       record
       { ratio =
           record { num = _l.ratio.num_1084 ; den = _l.ratio.den_1085 }
       ; owner = _l.owner_1083
       })-}
--(==to≡ {outputDatum ctx .fst} {d .fst} (get (get (go (newValue ctx == v) (go (checkMinValue v) (go (checkRational r) (go (checkSigned (owner (snd d)) ctx) (go (checkTokenIn (d .fst) ctx) p2))))))))

{-par l (Update val r) ctx pf
...
getS'm ctx = record
             ...
             ; continues = continues ctx
             ; spends = inputRef ctx
             ; hasToken = (assetClassValueOf (outputVal ctx) (tokAssetClass ctx)) == 1
             ; mint = mint ctx
             ; token = tokAssetClass ctx
             }
-}
